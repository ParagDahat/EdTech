...
const AnimatedMentors = ({ testimonials, autoplay = false }) => {
  ...
  return (
    <div className="mx-auto max-w-sm font-lato px-4 py-20 overflow-hidden antialiased md:max-w-4xl md:px-8 lg:px-12">
        <h3 className="text-5xl mb-6">Meet Our Professional Mentors</h3>
        <div className="w-40 h-1 bg-red-600 mx-auto mb-10"></div>
      <div className="relative grid grid-cols-1 gap-20 md:grid-cols-2">
        <div>
          <div className="relative h-44 md:h-80 w-full">
            <AnimatePresence>
